...
class DeleteCourseInstructor extends Component {
  constructor() {
    super();
    this.state = {
  ...
  handleUpdate = (event) => {
    ...
    axios
      .post(
        "http://localhost:3000/deleteCourseInstructor",
        {
      ...
      .then((response) => {
        ...
        if(response.data === "sorry this course is not in the department of that HOD"){
            this.setState({
              ...
              console.log("shit")
        }else if(res === "Please Enter Strings in the courseName field and instructor field"){
            this.setState({
                isLoading: false,
                result: "Please Enter Strings in the courseName field and instructor field"
              });
        }else if(res === "You are not authorized to do this"){
            this.setState({
                isLoading: false,
